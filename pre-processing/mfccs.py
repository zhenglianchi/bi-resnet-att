...
def save_pic(wav_dir,save_dir):
    ...
    for file in os.listdir(wav_dir):
        ...
        display.specshow(librosa.amplitude_to_db(mfcc,ref=np.max),y_axis='log',x_axis='time')
...
if __name__ == '__main__':
   save_pic('../data/train','../analysis/mfccs/train/')
   save_pic('../data/test','../analysis/mfccs/test/')
